...
class Record:
    ...
    lyric_onset_offset: Optional, a list of list, each sublist contains two elements, 
                        the first one is the onset time of a word, the second one is the offset time of a word
